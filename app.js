...
app.get('/players/:playerId/playerScores', async (request, response) => {
  ...
  response.send({
    playerId: playerIndividualscore['playerId'],
    playerName: playerIndividualscore['playerName'],
    totalScore: playerIndividualscore['totalScore'],
    totalFours: playerIndividualscore['totalFours'],
    totalSixes: playerIndividualscore['totalSixes'],
  })
})
